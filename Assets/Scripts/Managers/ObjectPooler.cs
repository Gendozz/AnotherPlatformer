...
public class ObjectPooler : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        foreach (Pool pool in pools)
        {
            ...
            {
                pool.container = new GameObject("ContainerForPooled_" + pool.poolTag + "s").transform; 
            }
        ...
        // TODO: Remake event telling pools are ready 

        //EventHub.RaiseEvent(GameEventType.OnPoolsAreReady);
